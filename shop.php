...
if(isset($_POST['add_to_cart'])){
   ...
   $check_cart_numbers = mysqli_query($conn, "SELECT * FROM `cart` WHERE name = '$product_name' AND description = '$product_description' AND user_id = '$user_id'") or die('query failed');
